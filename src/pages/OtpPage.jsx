          ...
          <div className="flex items-center md:gap-4 gap-2 mb-3">
            {otp.map((digit, i) => (
              <input
                ...
                className={` border border-neutral-300 bg-neutral-100/25 rounded-full lg:w-16 w-12 px-4 py-3 text-center focus:outline-0 focus:border-primary-400 ${
                  digit ? "border-primary-400" : ""
                }`}
                placeholder=""
              />
            ))}
