  ...
  return (
    <div className="flex flex-col gap-6 pr-5 border-r-2 border-neutral-black-5 h-full dark:border-neutral-700">
      ...
      <section className="flex flex-col gap-5">
        ...
        <div className="dark:bg-black bg-neutral-black-3 grid grid-cols-5 p-3 w-full rounded-xl place-items-center align-middle gap-3">
          <figure className="w-15 h-15 col-span-1 place-self-center">
            <img src={avatar} alt="" />
          </figure>
