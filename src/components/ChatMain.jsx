      ...
      {message.map((msg) => (
        ...
        >
          <div className="flex items-center gap-3 w-full max-w-2/3">
            <span
              className={`body-medium-medium ${
                msg.sender === "me" ? "bg-primary-300" : "bg-neutral-black-2"
              } px-3 py-4 rounded-xl ${
                msg.sender !== "me" ? "dark:bg-neutral-black-12" : ""
              }`}
            >
              {msg.text}
            </span>
          ...
          <div className="flex items-center gap-2">
            <span className="body-xsmall-regular">{formatTime(msg.time)}</span>
