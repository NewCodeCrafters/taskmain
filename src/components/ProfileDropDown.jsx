...
const ProfileDropDown = () => {
  ...
  return (
    <>
      <div 
      className="-bottom-80 right-0 absolute mt-2 md:mt-4  mr-5 w-full md:max-w-[276px] max-w-[220px] p-2 bg-white dark:bg-black dark:text-white rounded-xl flex flex-col gap-2 transition-all ease-in-out duration-500 z-50"
      >
