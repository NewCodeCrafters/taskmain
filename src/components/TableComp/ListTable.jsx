  ...
  return (
    <div className="scrollBar">
      <table className="min-w-full border-collapse bg-white ">
        <thead>
          <tr className="bg-neutral-black-5 dark:bg-neutral-black-12 dark:text-white body-small-semibold border-collapse border dark:border-neutral-600 border-gray-300 text-left">
            <th className="p-3">
            ...
            <th className="p-3 border dark:border-neutral-600 border-gray-300">
              Task Name
            </th>
            <th className="p-3  border dark:border-neutral-600 border-gray-300">
              Project
        ...
        <tbody>
          {currentData(data).map((task) => {
            ...
            return (
              <tr
                key={task.id}
                className="border hover:bg-gray-100 transition-all duration-200 ease-in-out cursor-pointer border-gray-300 dark:border-neutral-700 dark:hover:bg-neutral-black-12 dark:bg-black dark:text-white"
